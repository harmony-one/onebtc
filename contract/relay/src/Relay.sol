...
contract Relay is IRelay, PausableUpgradeable {
     ...
     */
    function __Relay__initialize(bytes memory header, uint32 height)
        public
        virtual
        initializer
    {
     ...
     */
    function submitBlockHeader(bytes calldata header)
        external
        override
        whenNotPaused
    {
     ...
     */
    function submitBlockHeaderBatch(bytes calldata headers)
        external
        override
        whenNotPaused
    {
